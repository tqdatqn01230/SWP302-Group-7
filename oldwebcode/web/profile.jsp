<%-- 
    Document   : profile
    Created on : Oct 24, 2021, 11:30:11 PM
    Author     : Dell
--%>
		...
		<div class="main-body">
			<div class="row">
					...
					<div class="card">
						<div class="card-body">
							<div class="d-flex flex-column align-items-center text-center">
								<img src=https://i1.sndcdn.com/avatars-000482795607-8hrf8t-t500x500.jpg" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
								<div class="mt-3">
                                                                        <%String a=user.getFullName(); %>
									<h4><%=user.getFullName() %></h4>
									<p class="text-secondary mb-1"><%=user.getRole()%></p>
									<p class="text-muted font-size-sm">FPT Student</p>
				...
				<div class="col-lg-8">
					<div class="card">
						<div class="card-body">
                                                    <form action="ChangeProfileController">
							<div class="row mb-3">
								<div class="col-sm-3">
								...
								<div class="col-sm-9 text-secondary">
                                                                    ...
                                                                    <%String error =(String)request.getAttribute("UserNameError"); 
                                                                    if (error==null) error="";%>
							<div class="row mb-3">
								<div class="col-sm-3">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-9 text-secondary">
									<input type="text" class="form-control" name="Mobile" value="(320) 741751">
								</div>
                                                        </div>					
							<div class="row">
