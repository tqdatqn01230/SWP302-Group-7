 ...
 * @author Dell
 */
@WebServlet(name = "CommentOnPostController", urlPatterns = {"/CommentOnPostController"})
public class CommentOnPostController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            CommentDTO comment=new CommentDTO(PostID, user.getUserID(), cmt);
