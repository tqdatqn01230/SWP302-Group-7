 ...
 * @author Dell
 */
@WebServlet(name = "ViewScheduleController", urlPatterns = {"/ViewScheduleController"})
public class ViewScheduleController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            List<TimetableDTO> list= dao.getListTimeTableByUserID(user.getUserID());
            List<LocalDate> listdate=new ArrayList<LocalDate>();
            LocalDate currentDate = LocalDate.now();
           
//            for (TimetableDTO item :list){
//                DateTimeFormatter dtf= DateTimeFormatter.ofPattern("yyyy-MM-dd");
//                String startString = item.getStarttime().substring(0,10);
//                String endString = item.getEndtime().substring(0,10);
...
//                }
//            }
            //request.setAttribute("Schedule", listdate);
