 ...
 * @author Dell
 */
@WebServlet(name = "CheckCodeController", urlPatterns = {"/CheckCodeController"})
public class CheckCodeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String code1 = (String) session.getAttribute("ConfirmCode");
        String code2 = request.getParameter("Code");
        String email = request.getParameter("Email");
        request.setAttribute("Email", email);
        if (code1.equals(code2)) request.getRequestDispatcher(Success).forward(request, response);
