...
public class LoginController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if (user==null){
                session.setAttribute("LOGIN_ERROR", "Wrong username or password");
            }else if(user.isStatus()){
                session.setAttribute("USER", user);
     
                if ("Admin".equals(user.getRole())) url=ADMIN_PAGE;
                else if ("Member".equals(user.getRole())) url=MEMBER_PAGE;
                else if ("Leader".equals(user.getRole())) url=CLUBLEADER_PAGE;
            }else{
